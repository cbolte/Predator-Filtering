...
```{r}
plot_rkm_time_vemco <- function(df, int_rkm = -100, str_start_datetime, str_end_datetime, pdf_name) {
  pdf(paste("C:\\Users\\cbolte\\Desktop\\Delta Salmon Project\\River Kilometer by Time\\", pdf_name, ".pdf", sep = "" )) 
...
```{r}
plot_rkm_time_jsats <- function(df, int_rkm = -100, str_start_datetime, str_end_datetime, pdf_name) {
  pdf(paste("C:\\Users\\cbolte\\Desktop\\Delta Salmon Project\\River Kilometer by Time\\", pdf_name, ".pdf", sep = "" )) 
...
upriver_movement_vemco <- function(all_detections, df_taglist, min_distance_km, low_rkm = 0, high_rkm = 550) {
  ...
  write.csv(df_removed_detections, "C:\\Users\\cbolte\\Desktop\\Delta Salmon Project\\CSVs\\Removed Detections Upstream Movement.csv")
